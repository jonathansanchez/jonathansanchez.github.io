 ...
 * https://github.com/jonathansanchez
 *
* ============================
* Copyright, MIT - 2017
...
/* core */
  var app = {
    cms: "Jonathan Sánchez",
    url: "http://jonathansanchez.github.io",
    version: "1.0.1",
    id: {
      update: update,
      username: username,
    ...
    deploy: function() {
      // run credits
      app.self.credits("Jonathan Sánchez", "http://jonathansanchez.github.io");
      // effect
      app.self.effect();
      // run all posts
  ...
  // Credits
  app.self.credits = function(author, domain) {
    app.log("CREDITS:" + " " + app.cms + " " + app.version);
    app.log("URL: " + app.url);
    app.log("------------------------------");
    app.log("Designed and coded by ( " + author + " | " + domain + " )");
    app.log("------------------------------");
  }
